...
namespace EFM
{
    public class MarketManager : MonoBehaviour
    {
        ...
        //        if (TraderStatus.fenceRestockTimer > 0)
        //        {
        //            TraderStatus.fenceRestockTimer -= Time.deltaTime;
        //        }
        //        else
        //        {
        //            TraderStatus.fenceRestockTimer = Convert.ToSingle((DateTime.Today.ToUniversalTime().AddHours(24) - DateTime.UtcNow).TotalSeconds);
        ...
        //        tradeVolume = transform.GetChild(1).gameObject.AddComponent<TradeVolume>();
        ...
        //        {
        //            int traderIndex = i;
        //            PointableButton pointableButton = traderButtonsParent.GetChild(traderIndex).gameObject.AddComponent<PointableButton>();
        ...
        //            if (traderTabs == null)
        //            {
        //                traderTabs = new TraderTab[4];
        //            }

        //            TraderTab tabScript = tab.gameObject.AddComponent<TraderTab>();
        ...
        //        PointableButton categoryTemplateToggleButton = categoryTemplate.transform.GetChild(0).GetChild(0).gameObject.AddComponent<PointableButton>();
        ...
        //        PointableButton itemViewTemplateWishButton = buyItemTemplate.transform.GetChild(3).gameObject.AddComponent<PointableButton>();
        ...
        //        PointableButton itemViewTemplateBuyButton = buyItemTemplate.transform.GetChild(2).gameObject.AddComponent<PointableButton>();
        ...
        //        PointableButton ragfairCartDealAmountButton = ragfairCartTransform.transform.GetChild(2).GetChild(0).GetChild(0).gameObject.AddComponent<PointableButton>();
        ...
        //        PointableButton ragfairCartCancelAmountButton = ragfairCartTransform.transform.GetChild(2).GetChild(0).GetChild(1).gameObject.AddComponent<PointableButton>();
        ...
        //    private void AddRagFairCategories(List<CategoryTreeNode> children, Transform parent, GameObject template, int level)
        //    {
        ...
        //            traderDisplay.GetChild(0).GetChild(1).GetChild(0).GetChild(0).GetChild(1).GetComponent<Text>().text = TraderStatus.LoyaltyLevelToRoman(loyaltyDetails.currentLevel);
        ...
        //            traderDisplay.GetChild(0).GetChild(2).GetChild(1).GetChild(0).GetChild(1).GetChild(0).GetChild(1).GetComponent<Text>().text = TraderStatus.LoyaltyLevelToRoman(loyaltyDetails.currentLevel);
        //        }
        //        else
        //        {
        //            // Trader details
        ...
        //                traderDisplay.GetChild(0).GetChild(2).GetChild(1).GetChild(1).GetChild(1).GetChild(0).GetChild(1).GetComponent<Text>().text = TraderStatus.LoyaltyLevelToRoman(loyaltyDetails.nextLevel);
        //            }
        //            else
        //            {
        ...
        //            }
        //            traderDisplay.GetChild(0).GetChild(2).GetChild(1).GetChild(1).GetChild(4).GetChild(1).GetComponent<Text>().text = TraderStatus.GetMoneyString(loyaltyDetails.nextMinSalesSum);
        ...
        //                HoverScroll newPriceDownHoverScroll = traderDisplay.GetChild(1).GetChild(3).GetChild(1).GetChild(1).GetChild(3).GetChild(3).gameObject.AddComponent<HoverScroll>();
        //                HoverScroll newPriceUpHoverScroll = traderDisplay.GetChild(1).GetChild(3).GetChild(1).GetChild(1).GetChild(3).GetChild(2).gameObject.AddComponent<HoverScroll>();
        ...
        //                        // Setup button
        //                        PointableButton pointableButton = currentItemIcon.gameObject.AddComponent<PointableButton>();
        //                        pointableButton.SetButton();
        ...
        //            if (!initButtonsSet)
        //            {
        //                PointableButton pointableBuyDealButton = traderDisplay.GetChild(1).GetChild(3).GetChild(1).GetChild(2).GetChild(0).GetChild(0).gameObject.AddComponent<PointableButton>();
        ...
        //                PointableButton pointableBuyAmountButton = traderDisplay.GetChild(1).GetChild(3).GetChild(1).GetChild(1).GetChild(1).gameObject.AddComponent<PointableButton>();
        ...
        //                // Set hover scrolls
        //                HoverScroll newDownHoverScroll = traderDisplay.GetChild(1).GetChild(3).GetChild(0).GetChild(1).GetChild(3).gameObject.AddComponent<HoverScroll>();
        //                HoverScroll newUpHoverScroll = traderDisplay.GetChild(1).GetChild(3).GetChild(0).GetChild(1).GetChild(2).gameObject.AddComponent<HoverScroll>();
        ...
        //            }
        //            HoverScroll downHoverScroll = traderDisplay.GetChild(1).GetChild(3).GetChild(0).GetChild(1).GetChild(3).GetComponent<HoverScroll>();
        //            HoverScroll upHoverScroll = traderDisplay.GetChild(1).GetChild(3).GetChild(0).GetChild(1).GetChild(2).GetComponent<HoverScroll>();
        ...
        //        // Setup ItemIcon
        //        ItemIcon itemIconScript = cartShowcase.GetChild(1).gameObject.GetComponent<ItemIcon>();
        //        if (itemIconScript == null)
        //        {
        //            itemIconScript = cartShowcase.GetChild(1).gameObject.AddComponent<ItemIcon>();
        //        }
        ...
        //            // Setup ItemIcon
        //            ItemIcon priceIconScript = priceElement.gameObject.AddComponent<ItemIcon>();
        ...
        //        if (TraderStatus.questConditionsByTask.ContainsKey(task.ID))
        //        {
        //            foreach (TraderTaskCondition taskCondition in TraderStatus.questConditionsByTask[task.ID])
        //            {
        //                // If the condition requires this task to be started
        //                if(taskCondition.value == 2)
        //                {
        //                    TraderStatus.FulfillCondition(taskCondition);
        //                }
        //            }
        //        }
        ...
        //        foreach (TraderStatus trader in Mod.traderStatuses)
        //        {
