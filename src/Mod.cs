...
namespace EFM
{
    ...
    public class Mod : BaseUnityPlugin
    {
        ...
        public static readonly float[] sizeVolumes = { 1000, 2000, 5000, 30000, 0, 50000}; // 0: Small, 1: Medium, 2: Large, 3: Massive, 4: None, 5: CantCarryBig
        ...
        public static void FetchAvailableSaveFiles()
        {
            ...
            {
                if (!path.EndsWith("DefaultSave.sav") && path.EndsWith(".sav"))
                {
